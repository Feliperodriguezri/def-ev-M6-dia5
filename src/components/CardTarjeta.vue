<template>
  <div class="contenedorTarjeta">
    ...
    <div class="tarjeta">
      ...
      <div>
        <h2>{{ numero }}</h2>
        <span>Fecha Exp: <b>{{ fechaExpiracion }}</b></span>
      </div>
      <footer>
...
export default {
  ...
  data() {
    return {
      tituloTarjeta: "Aqui agrega el titulo",
      chip: "./img/chip.png",
      numero: "",
      fechaExpiracion: "",
      propietario: "",
      tipoTarjeta: "./img/visa.png"
    }
  }
}
</script>
